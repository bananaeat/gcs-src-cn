...
public final class NewSkillCommand extends Command {
    ...
    public static final NewSkillCommand INSTANCE                = new NewSkillCommand(false, false, I18n.text("新建技能"), CMD_NEW_SKILL, KeyEvent.VK_K, COMMAND_MODIFIER);
    /** The "New Skill Container" command. */
    public static final NewSkillCommand CONTAINER_INSTANCE      = new NewSkillCommand(true, false, I18n.text("新建技能容器"), CMD_NEW_SKILL_CONTAINER, KeyEvent.VK_K, SHIFTED_COMMAND_MODIFIER);
    /** The "New Technique" command. */
    public static final NewSkillCommand TECHNIQUE_INSTANCE      = new NewSkillCommand(false, true, I18n.text("新建技法"), CMD_NEW_TECHNIQUE, KeyEvent.VK_T, COMMAND_MODIFIER);
