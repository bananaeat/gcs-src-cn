...
public final class NewEquipmentModifierCommand extends Command {
    ...
    public static final NewEquipmentModifierCommand INSTANCE                             = new NewEquipmentModifierCommand(false, I18n.text("新建装备修正"), CMD_NEW_EQUIPMENT_MODIFIER, COMMAND_MODIFIER);
    public static final NewEquipmentModifierCommand CONTAINER_INSTANCE                   = new NewEquipmentModifierCommand(true, I18n.text("新建装备修正容器"), CMD_NEW_EQUIPMENT_MODIFIER_CONTAINER, SHIFTED_COMMAND_MODIFIER);
