...
public final class NewEquipmentCommand extends Command {
    ...
    public static final NewEquipmentCommand CARRIED_INSTANCE                  = new NewEquipmentCommand(true, false, I18n.text("新建随身装备"), CMD_NEW_EQUIPMENT, COMMAND_MODIFIER);
    /** The "New Carried Equipment Container" command. */
    public static final NewEquipmentCommand CARRIED_CONTAINER_INSTANCE        = new NewEquipmentCommand(true, true, I18n.text("新建随身装备容器"), CMD_NEW_EQUIPMENT_CONTAINER, SHIFTED_COMMAND_MODIFIER);
    /** The "New Other Equipment" command. */
    public static final NewEquipmentCommand NOT_CARRIED_INSTANCE              = new NewEquipmentCommand(false, false, I18n.text("新建其他装备"), CMD_NEW_OTHER_EQUIPMENT, COMMAND_MODIFIER | InputEvent.ALT_DOWN_MASK);
    /** The "New Other Equipment Container" command. */
    public static final NewEquipmentCommand NOT_CARRIED_CONTAINER_INSTANCE    = new NewEquipmentCommand(false, true, I18n.text("新建随身装备容器"), CMD_NEW_OTHER_EQUIPMENT_CONTAINER, SHIFTED_COMMAND_MODIFIER | InputEvent.ALT_DOWN_MASK);
