...
public final class NewAdvantageCommand extends Command {
    ...
    public static final NewAdvantageCommand INSTANCE                    = new NewAdvantageCommand(false, I18n.text("新建优势"), CMD_NEW_ADVANTAGE, COMMAND_MODIFIER);
    /** The "New Advantage Container" command. */
    public static final NewAdvantageCommand CONTAINER_INSTANCE          = new NewAdvantageCommand(true, I18n.text("新建优势容器"), CMD_NEW_ADVANTAGE_CONTAINER, SHIFTED_COMMAND_MODIFIER);
