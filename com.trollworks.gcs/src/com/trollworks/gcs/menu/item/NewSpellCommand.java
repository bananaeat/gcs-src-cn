...
public final class NewSpellCommand extends Command {
    ...
    public static final NewSpellCommand INSTANCE               = new NewSpellCommand(false, I18n.text("新建法术"), CMD_SPELL, COMMAND_MODIFIER);
    /** The "New Spell Container" command. */
    public static final NewSpellCommand CONTAINER_INSTANCE     = new NewSpellCommand(true, I18n.text("新建法术容器"), CMD_SPELL_CONTAINER, SHIFTED_COMMAND_MODIFIER);
    ...
    private NewSpellCommand() {
        super(I18n.text("新建仪式法术"), CMD_RITUAL_MAGIC_SPELL);
        mRitualMagic = true;
    }
