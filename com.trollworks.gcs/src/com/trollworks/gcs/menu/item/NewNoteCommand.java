...
public final class NewNoteCommand extends Command {
    ...
    public static final NewNoteCommand INSTANCE               = new NewNoteCommand(false, I18n.text("新建备注"), CMD_NEW_NOTE, SHIFTED_COMMAND_MODIFIER);
    /** The "New Note Container" command. */
    public static final NewNoteCommand CONTAINER_INSTANCE     = new NewNoteCommand(true, I18n.text("新建备注容器"), CMD_NEW_NOTE_CONTAINER, COMMAND_MODIFIER | InputEvent.ALT_DOWN_MASK);
