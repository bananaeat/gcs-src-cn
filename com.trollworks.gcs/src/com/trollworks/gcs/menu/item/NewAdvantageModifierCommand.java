...
public final class NewAdvantageModifierCommand extends Command {
    ...
    public static final NewAdvantageModifierCommand INSTANCE                             = new NewAdvantageModifierCommand(false, I18n.text("新建优势修正"), CMD_NEW_ADVANTAGE_MODIFIER, COMMAND_MODIFIER);
    public static final NewAdvantageModifierCommand CONTAINER_INSTANCE                   = new NewAdvantageModifierCommand(true, I18n.text("新建优势修正容器"), CMD_NEW_ADVANTAGE_MODIFIER_CONTAINER, SHIFTED_COMMAND_MODIFIER);
