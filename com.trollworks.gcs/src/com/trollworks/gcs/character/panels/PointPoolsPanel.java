...
public class PointPoolsPanel extends DropPanel {
    public PointPoolsPanel(CharacterSheet sheet) {
        super(new PrecisionLayout().setColumns(6).setMargins(0).setSpacing(2, 0).setFillAlignment(), I18n.text("点数池"));
